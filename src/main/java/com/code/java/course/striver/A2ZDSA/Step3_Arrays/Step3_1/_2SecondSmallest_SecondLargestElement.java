 ...
 */
public class _2SecondSmallest_SecondLargestElement {
    public static void main(String[] args) {
        System.out.println(Arrays.toString(getSecondOrderElements(7, new int[] { 8, 2, 6, 3, 2, 7, 8 })));
        System.out.println(Arrays.toString(practice(7, new int[] { 8, 2, 6, 3, 2, 7, 8 })));
    }
    ...
    //same as above
    public static int[] practice(int n, int[] a) {
        int min = Integer.MAX_VALUE;
        int second_min = Integer.MAX_VALUE;
        int max = Integer.MIN_VALUE;
        int second_max = Integer.MIN_VALUE;
        for (int val : a) {
            ...
            if (val < min) {
                second_min = min;
                min = val;
            } else if (val < second_min && val > min)
                second_min = val;
